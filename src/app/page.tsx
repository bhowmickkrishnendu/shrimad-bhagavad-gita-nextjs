  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Uncover the timeless wisdom of the Bhagavad Gita and apply its teachings to modern life. Explore profound insights on dharma, karma, and the path to inner peace and self-realization." />
        <meta name="keywords" content="Shrimad Bhagavad Gita, Shrimadbhagavadgita, Bhagavadgita, Bhagavad Gita, Shrimad Bhagwat Gita, Shrimad Bhagavad Geeta, Gita, Arjunavishad Yoga, Arjuna Viṣhāda Yoga, Sankhya Yoga, Karma Yoga, Jnana Yoga, Gyana Yoga, Karma Sanyāsa Yoga, Karma Sanyasa Yoga, Dhyāna Yoga, Dhyana Yoga, Vijnana Yoga, Bigyana Yoga, Akṣhara Parabrahma Yoga, Rāja Vidyā Yoga, Raj Vidya Yoga, Vibhūti Yoga, Vibhuti Yoga, Viśhwarūpa Sandarśhana Yoga, Vishwarupa Darshan Yoga, Vishwaroop darshan Yoga, Bhakti Yoga, Kṣhetra Kṣhetrajña Vibhāga Yoga, Guṇa Traya Vibhāga Yoga, Puruṣhottama Yoga, Moksha Yoga, Purushottam Yoga, Gunatraya Vibhaga Yoga" />
        ...
        <meta property="og:description" content="Uncover the timeless wisdom of the Bhagavad Gita and apply its teachings to modern life. Explore profound insights on dharma, karma, and the path to inner peace and self-realization." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://shrimadbhagvadgita.org/" />
        <meta property="og:image" content="/Dharma-01.jpg" />
        <link rel="canonical" href="https://shrimadbhagvadgita.org/" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      {loading ? (
        <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-gradient-to-br from-yellow-100 via-orange-100 to-yellow-200 animate-gradient-x">
          {/* Dharma image in a circle above the title */}
          <div className="mb-3 flex items-center justify-center">
            <div className="w-28 h-28 sm:w-36 sm:h-36 rounded-full bg-white shadow-lg border-4 border-yellow-300 overflow-hidden flex items-center justify-center">
              <Image src="/Dharma-01.jpg" alt="Dharma" width={144} height={144} className="w-full h-full object-cover rounded-full" />
            </div>
          </div>
          {/* Title below the image */}
          <span className="mb-2 text-2xl sm:text-3xl font-extrabold bg-gradient-to-r from-orange-400 via-yellow-500 to-orange-600 bg-clip-text text-transparent drop-shadow-2xl text-center tracking-tight animate-gradient-x">Shrimad Bhagavad Gita</span>
          {/* Small gap between title and loading rectangle */}
          <div className="mb-3" />
          {/* Rectangle for loading text, normal width, smaller height */}
          <div className="relative w-80 h-16 flex items-center justify-center bg-gradient-to-br from-yellow-100 via-orange-100 to-yellow-200 rounded-3xl shadow-2xl border border-yellow-300/60 backdrop-blur-xl">
            <span className="text-xl sm:text-2xl text-yellow-900/90 text-center font-semibold drop-shadow-lg">Loading your journey…</span>
          </div>
          {/* Loader progress bar and percentage below the rectangle */}
          <div className="mt-6 w-80 h-6 bg-yellow-100/60 rounded-full shadow-inner border border-yellow-300/60 flex items-center relative">
            <div
              className="h-6 rounded-full bg-gradient-to-r from-orange-400 via-yellow-400 to-orange-300 shadow-lg animate-gradient-x"
              style={{ width: `${progress}%`, transition: 'width 0.1s linear' }}
            />
            <span className="absolute right-4 text-yellow-900 font-bold text-lg">{progress}%</span>
          </div>
        </div>
      ) : (
        <>
